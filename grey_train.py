...
"""
train_loader = DataLoader(train_data, batch_size=cfgs.batch_size, shuffle=True, num_workers =6, pin_memory=True)
val_loader = DataLoader(val_data, batch_size=cfgs.batch_size, shuffle=False, num_workers =6, pin_memory=True)
test_loader = DataLoader(test_data, batch_size=cfgs.batch_size, shuffle=False)
"""
